...
if (isset($submit)) {
	...
	if (empty($errors)) {
		...
		header('Location: https://' . $_SERVER['SERVER_NAME'] . '/ao/thanks.php');
		exit;
	}
...
<html>
 <head>
  <title>Dealership Forms:::: Auto Opportunity</title>
    ...
    <td height="354" align="center">
     <form method="post" action="<?=$PHP_SELF?>">
      <table border="0" cellpadding="1" cellspacing="0">
       <tr>
        <td align="center" class="big"><p class="huge style1">Auto Opportunity</p>
          <p><b>
                <?=$title?>
</b></p>
