...
This is an Auto Opportunity dealer.
...
";
		mail('info@goDEALERtoDEALER.com, daviddraeger@cox.net, jack@estesservices.com', 'New Dealer - Request Info - Auto Opportunity', $msg, $EMAIL_FROM);
...
<html>
 <head>
  <title>Request Form:::: Auto Opportunity</title>
    ...
    <td height="689" align="center">
     <form method="post" action="<?=$PHP_SELF?>">
      <table border="0" cellpadding="1" cellspacing="0">
       <tr>
        <td align="center" class="big" colspan="2"><p class="huge style1">Auto Opportunity </p>
          <p><b>
                <?=$title?>
</b></p>
          <p>&nbsp;</p></td>
