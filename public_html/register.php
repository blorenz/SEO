...
extract(defineVars("poc_f_name","poc_l_name","poc_title","poc_email","topdog_name","topdog_title","industry","dealer","address1","address2","city","state","zip","phone","referral_code","submit"));
...
if (isset($submit)) {
	...
	if (empty($errors)) {
		...
		$id = db_insert_id();
		$msg = "A dealer is requesting information and requires contact.
...
";
		mail('info@goDEALERtoDEALER.com', 'Dealer Requesting Info', $msg, $EMAIL_FROM);
    ...
    <td height="689" align="center">
     <form method="post" action="<?=$PHP_SELF?>">
      <table border="0" cellpadding="1" cellspacing="0">
       <tr>
        <td align="center" class="big" colspan="2"><b><?=$title?></b></td>
       </tr>
...
<?php if (!empty($errors)) { ?>
       ...
       <tr>
         <td colspan="2"><div align="center">
           <p><strong>Fill out this form to request more information</strong></p>
           <p>&nbsp; </p>
         </div></td>
       </tr>
<?php } ?>
...
?>
       ...
       <tr><td colspan="2">&nbsp;</td></tr>
	   <tr>
        <td align="right" valign="top" class="header">Referral Code:&nbsp;</td>
        <td class="normal"><input type="text" name="referral_code" size="35" value="<?=$referral_code?>" />
			<br>(for association referalls only,<br>leave blank if not referred by association)</td>
       </tr>
	   <tr>
       ...
       <tr>
        <td align="center" class="normal" colspan="2"><input type="submit" name="submit" value=" Submit Request ">&nbsp;&nbsp;&nbsp;<input type="reset" value="Clear"></td>
       </tr>
      </table>
     </form>    </td>
    <td>&nbsp;</td>
