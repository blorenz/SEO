...
This is an AutoUpLink USA dealer and has been saved to that RM.
...
";
		mail('info@goDEALERtoDEALER.com', 'New Dealer - AutoUpLink USA', $msg, $EMAIL_FROM);
...
<html>
 <head>
  <title>Sign Up Form:::: AutoUplink USA</title>
    ...
    <td height="689" align="center">
     <form method="post" action="<?=$PHP_SELF?>">
      <table border="0" cellpadding="1" cellspacing="0">
       <tr>
        <td align="center" class="big" colspan="2"><p><img src="../docs/affiliations/images/AULUSAlogo.gif" width="283" height="64"></p>
          <p><b>
                <?=$title?>
</b></p>
          <p>&nbsp;</p></td>
...
?>
      ...
      <input type="hidden" name="refferal_code" value="aul" />
     </form>    </td>
    <td>&nbsp;</td>
   </tr>
   <tr><td colspan="2">&nbsp;</td></tr>
