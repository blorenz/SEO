...
";
		mail('info@godealertodealer.com, cjohnson@godealertodealer.com', 'New Dealer Signup - IDEAL', $msg, $EMAIL_FROM);

		header('Location: http://' . $_SERVER['SERVER_NAME'] . '/ideal/thanks1.php');
		exit;
	}
