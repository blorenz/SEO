...
<?php if ($did == 0) { ?>
   ...
   <tr> 
	...
	<td class="header"><b><a href="reports.php?ae_id=<?=$ae_id?>&order=name">Dealer Name</a></b></td>
    <td class="header"><b><a href="reports.php?ae_id=<?=$ae_id?>&order=address">Address</a></b></td>
    <td class="header"><b><a href="reports.php?ae_id=<?=$ae_id?>&order=city">City</a></b></td>
    <td class="header"><b><a href="reports.php?ae_id=<?=$ae_id?>&order=state">State</a></b></td>
    <td class="header"><b><a href="reports.php?ae_id=<?=$ae_id?>&order=zip">Zip</a></b></td>
	<td class="header"><b><a href="reports.php?ae_id=<?=$ae_id?>&order=phone">Phone</a></b></td>
    <td class="header"><b><a href="reports.php?ae_id=<?=$ae_id?>&order=created">Date</a></b></td>
   </tr>  
<?php } else { ?>
	<tr><td colspan="9"><?php echo $nav_links; ?></td></tr>
	<tr>
    <td class="header"><b>AE Name</b></td>
	<td class="header"><b><a href="reports.php?did=<?=$did?>&order=name">Dealer Name</a></b></td>
    <td class="header"><b><a href="reports.php?did=<?=$did?>&order=address">Address</a></b></td>
    <td class="header"><b><a href="reports.php?did=<?=$did?>&order=city">City</a></b></td>
    <td class="header"><b><a href="reports.php?did=<?=$did?>&order=state">State</a></b></td>
    <td class="header"><b><a href="reports.php?did=<?=$did?>&order=zip">Zip</a></b></td>
	<td class="header"><b><a href="reports.php?did=<?=$did?>&order=phone">Phone</a></b></td>
    <td class="header"><b><a href="reports.php?did=<?=$did?>&order=created">Date</a></b></td>
   </tr> 
<?php }
	$bgcolor = '#FFFFFF';
...
?>
	...
	<tr bgcolor="<?=$bgcolor?>">
		...
		&nbsp;&nbsp;("Tentative" Follow-up on: <?=$meeting?>)</td>
	</tr>
	<tr bgcolor="<?=$bgcolor?>">
		<td>&nbsp;</td>
