...
?>
			<table border="0" cellpadding="3" cellspacing="0" width="100%">
				...
				<tr valign="top" class="normal">
					<td><a href="https://www.godealertodealer.com/dms/message/alerts.php">Alerts
					    From Other DMs </a></td>
					<td><?=$alert_dm;?></td>
				</tr>
				<tr valign="top" class="normal">
				...
				<tr valign="top" class="normal">
					<td><a href="https://www.godealertodealer.com/dms/message/alerts.php">Alerts From Dealerships</a></td><td><?=$alert_dl;?>
					</td>					
				</tr>
			</table>
