...
if(!empty($_REQUEST['poc2_f_name']))
	$poc2_f_name = $_REQUEST['poc2_f_name'];
else
	$poc2_f_name = "";

if(!empty($_REQUEST['poc2_m_name']))
	$poc2_m_name = $_REQUEST['poc2_m_name'];
else
	$poc2_m_name = "";

if(!empty($_REQUEST['poc2_l_name']))
	$poc2_l_name = $_REQUEST['poc2_l_name'];
else
	$poc2_l_name = "";

if(!empty($_REQUEST['poc2_title']))
	$poc2_title = $_REQUEST['poc2_title'];
else
	$poc2_title = "";

if(!empty($_REQUEST['poc2_email']))
	$poc2_email = $_REQUEST['poc2_email'];
else
	$poc2_email = "";

if(!empty($_REQUEST['poc2_phone ']))
	$poc2_phone  = $_REQUEST['poc2_phone '];
else
	$poc2_phone  = "";

if(!empty($_REQUEST['poc2_fax']))
	$poc2_fax = $_REQUEST['poc2_fax'];
else
	$poc2_fax = "";
...
if(!empty($_REQUEST['_privs']))
	$_privs = $_REQUEST['_privs'];
else
	$_privs = "";
...
if(!empty($_REQUEST['limited']))
	$limited = $_REQUEST['limited'];
else
	$limited = "";
 ...
 *  in the dealers/ folder, one level below this file.
 *
 *  dms/
 *   aes/
 *     _form_dealer.php (you are here)
 *     dealers/
 * 	   _form_dealer.php (you also want to be here)
 */
?>
...
<table align="center" cellpadding="1" cellspacing="1" class="normal">
	<tr>
		<td class="header" align="right">Assign To:</td>
		<td class="normal" align="left">
			<select name="ae_id">
				<option value="" selected>Choose AE</option>
				<?php $result_ae = db_do("SELECT id, CONCAT(first_name, ' ', last_name) FROM aes WHERE dm_id='$dm_id' and status='active'");
					while (list($ae_id, $ae_name) = db_row($result_ae)) { ?>
						<option value="<?=$ae_id?>"><?=$ae_name?></option>
				<?php } ?>
...
?>
          ...
          <tr>
            <td class="normal">
              ...
              BidPay
              <input type="checkbox" name="pmt_method[]" value="Wire Transfer" <?php if (in_array("Wire Transfer", $pmt_method)) echo 'checked'; ?>>
              Wire Transfer
              </td>
          </tr>
      </table>
<table width="550" align="center" cellpadding="1" cellspacing="1" class="normal">
	...
	<tr>
		<td class="big" align="center" colspan="2"><b><u>Personal Notes</u></b></td>
	</tr>
	<tr>
...
<table width="600" align="center" cellpadding="1" cellspacing="1" class="normal">
	...
	<tr>
		<td align="center" class="normal">
			<input type='submit' name='save' value='Save to AE'>
		</td>
	</tr>
</table>
</form>
