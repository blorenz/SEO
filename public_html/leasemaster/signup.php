...
";
		mail('info@godealertodealer.com, ivan@leasemaster.com', 'New Dealer Signup - Lease Master', $msg, $EMAIL_FROM);

		header('Location: http://' . $_SERVER['SERVER_NAME'] . '/leasemaster/thanks1.php');
		exit;
	}
