...
<?php if (isset($id)) { ?>
	<table border="0" cellpadding="0" cellspacing="0" align="center"  width="450">
		...
		<tr>
			...
			<?php echo "<font size='6'><a href=\"mailto:jobs@godealertodealer.com?subject=$title - $citycaps\">Submit Resume</a></font><br><br><br><br>";
		...
		<tr>
			<td align="center" class="normal">
				...
				<?php while (list ($id, $title) = db_row($result))
					echo "<a href='jobs.php?city=$city&id=$id'>$title</a><br>";?><br><br><br>
			</td>
		</tr>
	</table>
<?php } ?>
