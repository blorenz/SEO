...
<table width="855" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="51" height="208" background="images/index/5.gif" valign="top" class="normal">
      <p></p>
    </td>
    <td width="14"></td>
    <td width="10"></td>

    <td width="383" valign="top" class="normal">
      <p align="center"><span class="style1  huge"><font size="6">Video Tutorials</font><br>
        <br>
        </span> <a href="http://gdtd.safesecuredemo.com/training/testing082910/testing082910.html">                 <font color="#00FFFF">-Testing for the Advisory Board </font></a>
		</span> <a href="http://gdtd.safesecuredemo.com/_trainingVideos/LOGIN/loginFORtesting/loginFORtesting.html"><font color="#00FFFF">-How to login for the Advisory Board </font></a>
		<br>

       <a href="http://gdtd.safesecuredemo.com/_trainingVideos/buyavehicle1/buyavehicle1.html">-&nbsp;How to buy a vehicle.  <font color="#FF0000">"NEW"</font></a>


	   <a href="http://gdtd.safesecuredemo.com/BugzillaTutorial/BugzillaTutorial.html">-&nbsp;Bugzilla Tutorial  <font color="#FF0000">"NEW"</font></a>




<!--		<a href="docs/presentations">-&nbsp;How to sell a vehicle.</a>
        ...
        <a href="docs/demos">-&nbsp;Online Demos </a>
	-->
      </p>
    </td>
	<td width="15"></td>
    <td width="382" valign="top" class="normal">
      <p>&nbsp;</p>
      <p><br>
        <a class=signup_img href="cioletter.php"><img src="images/index/carpics.gif" alt="Sign Up HERE!" width="250" height="148" border="0"></a></p>
	  </td>
