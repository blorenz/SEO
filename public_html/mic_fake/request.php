...
";
		mail('info@goDEALERtoDEALER.com, rbender@godealertodealer.com, nframe@micsystems.com', 'New Dealer - Request Info - MIC', $msg, $EMAIL_FROM);
    ...
    <td height="689" align="center">
     <form method="post" action="<?=$PHP_SELF?>">
      <table border="0" cellpadding="1" cellspacing="0">
       <tr>
        <td align="center" class="big" colspan="2"><p class="huge style1"><img src="mic.jpg" width="952" height="144"></p>
          <p><b>
                <?=$title?>
</b></p>
          <p>&nbsp;</p></td>
