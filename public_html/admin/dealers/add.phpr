...
//  POSSIBLE ERROR IN FOLLOWING LINE???   RJM    I MIGHT HAVE DELETED SOMETHING????  //

	if (empty($errors) || $status == 'cid') {
		...
		db_do("INSERT INTO dealers SET dm_id='$dm_id', address1='$address1', address2='$address2', bd_account='$bd_account', " .
         ...
         "poc2_email='$poc2_email', poc2_f_name='$poc2_f_name', poc2_m_name='$poc2_m_name', " .
			...
			"years='$years', zip='$zip', payment_method='$payment_method',
			charter_member='$charter_member', invoice='$invoice', no_of_stores='$no_of_stores', referral_code='$referral_code', type='$type', feed_provider='$feed_provider',
