...
<?php } ?>
	...
	<?php } ?>
		...
		<input type="hidden" name="status_orig" value="<?php echo $status_orig; ?>" />
<table width="550" align="center" cellpadding="1" cellspacing="1" class="normal">
	<tr>
		...
		<?php if (isset($id) && $id>0) { ?>
			<select name="ae_id">
				...
				<?php $result_ae = db_do("SELECT id, CONCAT(first_name, ' ', last_name) FROM aes WHERE status='active'");
					while (list($ae_id, $ae_name) = db_row($result_ae)) { ?>
						<option value="<?=$ae_id?>" <?php if ($ae_id == $aeid) echo 'selected'; ?>><?=$ae_name?></option>
				<?php } ?>
			</select>
		<?php } else { ?>
			<select name="dm_id">
				<option value="" selected>Choose DM</option>
				<?php $result_dm = db_do("SELECT id, CONCAT(first_name, ' ', last_name) FROM dms WHERE status='active'");
					while (list($dm_id, $dm_name) = db_row($result_dm)) { ?>
	...
	<!--     Randy M. brought the owners name and title to the top on 082910
-->
	<tr>
...
<table width="550" align="center" cellpadding="1" cellspacing="1" class="normal">
	...
	<tr>
		<td width="175" align="right" class="header">Contact Cell:&nbsp;</td>
...
<table width="600" align="center" cellpadding="1" cellspacing="1" class="normal">
	<tr>
		<td align="center" class="normal">
			...
			<option value="saved" <?php if ($status == 'saved') echo 'selected'; ?>>saved</option>
			</select>
		</td>
	</tr>
	<tr><td colspan="2">&nbsp;</td></tr>
