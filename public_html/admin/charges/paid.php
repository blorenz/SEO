...
?>
    <tr>
     <td class="header"><a href="?s=<?php echo $status; ?>&sort=charges.id<?php if(isset($stats)) { echo "&stats=$stats"; } ?>&dir=<?php if($sort == 'charges.id') { echo $otherdir; } else { echo $dir; } ?>"><b>Invoice Number</b></a></td>

     <td class="header">Paid</td>

     <td align="right" class="header"><a href="?s=<?php echo $status; ?>&sort=charges.fee<?php if(isset($stats)) { echo "&stats=$stats"; } ?>&dir=<?php if($sort == 'charges.fee') { echo $otherdir; } else { echo $dir; } ?>"><b>Fee (US $)</b></a></td>
     <td align="left" class="header"><a href="?s=<?php echo $status; ?>&sort=charges.fee_type<?php if(isset($stats)) { echo "&stats=$stats"; } ?>&dir=<?php if($sort == 'charges.fee_type') { echo $otherdir; } else { echo $dir; } ?>"><b>Fee Type</b></a></td>
	 <td class="header"><a href="?s=<?php echo $status; ?>&sort=auctions.title<?php if(isset($stats)) { echo "&stats=$stats"; } ?>&dir=<?php if($sort == 'auctions.title') { echo $otherdir; } else { echo $dir; } ?>"><b>Auction Title</b></a></td>
     <td class="header"><a href="?s=<?php echo $status; ?>&sort=charges.auction_id<?php if(isset($stats)) { echo "&stats=$stats"; } ?>&dir=<?php if($sort == 'charges.auction_id') { echo $otherdir; } else { echo $dir; } ?>"><b>Auction #</b></a></td>
     <td class="header"><a href="?s=<?php echo $status; ?>&sort=dealers.name<?php if(isset($stats)) { echo "&stats=$stats"; } ?>&dir=<?php if($sort == 'dealers.name') { echo $otherdir; } else { echo $dir; } ?>"><b>Dealership</b></a></td>
    </tr>
<?php
	$bgcolor = '#FFFFFF';
