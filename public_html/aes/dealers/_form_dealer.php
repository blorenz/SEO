...
<table width="550" align="center" cellpadding="1" cellspacing="1" class="normal">
   ...
   <tr>
		<td width="175" align="right" class="header">Type of Dealership:</td>
		<td class="normal"><select name="type">
			<option value="Franchise" <?php if ($type == 'Franchise') echo 'selected'; ?>>Franchise</option>
			<option value="Independent" <?php if ($type == 'Independent') echo 'selected'; ?>>Independent</option></select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="175" align="right" class="header">Inventory Management Company:&nbsp;</td>
...
<table width="550" align="center" cellpadding="1" cellspacing="1" class="normal">
   ...
   <tr>
		<td class="big" align="center" colspan="2">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		<td width="175" align="right" class="header"><b><u>Owner/Pres./CEO:</u></b>&nbsp;</td>
