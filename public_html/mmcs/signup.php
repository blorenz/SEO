...
";
		mail('info@godealertodealer.com, julia@motorcyclemanagement.com', 'New Dealer Signup - MMCS', $msg, $EMAIL_FROM);

		header('Location: http://' . $_SERVER['SERVER_NAME'] . '/mmcs/thanks1.php');
		exit;
	}
