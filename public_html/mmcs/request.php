...
";
		mail('info@goDEALERtoDEALER.com, julia@motorcyclemanagement.com', 'New Dealer - Request Info - MMCS', $msg, $EMAIL_FROM);

		header('Location: http://' . $_SERVER['SERVER_NAME'] . '/mmcs/thanks.php');
		exit;
	}
    ...
    <td height="689" align="center">
     <form method="post" action="<?=$PHP_SELF?>">
      <table border="0" cellpadding="1" cellspacing="0">
       <tr>
        <td align="center" class="big" colspan="2"><p class="huge style1">Motorcycle Management Consulting Services </p>
          <p><b>
                <?=$title?>
</b></p>
          <p>&nbsp;</p></td>
