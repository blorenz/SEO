...
This is an iboats.com dealer and has been saved to that RM.
...
";
		mail('info@goDEALERtoDEALER.com, drew@iboats.com, tom@iboats.com', 'New Dealer - iboats.com', $msg, $EMAIL_FROM);

		header('Location: http://' . $_SERVER['SERVER_NAME'] . '/iboats/thanks.php');
		exit;
	}
...
<html>
 <head>
  <title>Sign Up Form:::: iboats.com</title>
    ...
    <td height="689" align="center">
     <form method="post" action="<?=$PHP_SELF?>">
      <table border="0" cellpadding="1" cellspacing="0">
       <tr>
        <td align="center" class="big" colspan="2"><p><b><img src="iboats.gif" width="200" height="63"></b></p>
          <p><b>
                <?=$title?>
</b></p>
          <p>&nbsp;</p></td>
...
?>
      ...
      <input type="hidden" name="refferal_code" value="iboats" />
     </form>    </td>
    <td>&nbsp;</td>
   </tr>
   <tr><td colspan="2">&nbsp;</td></tr>
