...
$result_cid = db_do("SELECT category_id FROM auctions WHERE id=$auction_id");
list($category_id) = db_row($result_cid);

if (isset($category_id)){
	$result_cname = db_do("SELECT name FROM categories WHERE id=$category_id");
...
<table width="550" border="0" align="center" cellpadding="4" cellspacing="1">
	<tr align="center" class="normal">
  		<td><b>Showing <?=$num_of_ratings_show?> of <?=$num_of_ratings?> Ratings</b></td>
	</tr>
</table><br><br>
<table width="550" border="0" align="center" cellpadding="4" cellspacing="1">
	<tr align="center" class="normal">
