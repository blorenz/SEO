...
";
		mail('info@goDEALERtoDEALER.com, rbender@godealertodealer.com', 'New Dealer - Request Info - IDEAL', $msg, $EMAIL_FROM);

		header('Location: http://' . $_SERVER['SERVER_NAME'] . '/ideal/thanks.php');
		exit;
	}
...
<html>
 <head>
  <title>Request Form:::: IDEAL</title>
    ...
    <td height="689" align="center">
     <form method="post" action="<?=$PHP_SELF?>">
      <table border="0" cellpadding="1" cellspacing="0">
       <tr>
        <td align="center" class="big" colspan="2"><p class="huge style1"><img src="ideal.jpg" width="647" height="74"></p>
          <p><b>
                <?=$title?>
</b></p>
          <p>&nbsp;</p></td>
