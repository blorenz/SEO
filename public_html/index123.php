...
<table border="0" cellpadding="0" cellspacing="0">
   <tr  width="212">
   	<td width="212" valign="top" class="normal"><p align="left">
		
  <!-- 	<a href="brochure.php">-&nbsp;Online Brochure</a>     -->
        <a href="docs/testimonials">-&nbsp;Testimonials</a> <a href="docs/presentations">-&nbsp;Online Presentations </a>
  <!--  <a href="docs/businessops">-&nbsp;Business Opportunities</a>   -->
        <a href="docs/press">-&nbsp;Press Release</a> <a href="docs/about">-&nbsp;About 
        Us</a> <a href="docs/affiliations">-&nbsp;Affiliations</a> <a href="faq.php">-&nbsp;FAQ's</a> 
...
<table border="0" cellpadding="0" cellspacing="0">
   ...
   <div class="no_hover">
	  ...
	  <SCRIPT LANGUAGE="JavaScript" TYPE="text/javascript" SRC="//smarticon.geotrust.com/si.js"></SCRIPT>
	    ...
	    </i></font><font color="#FFFFFF"><i> <br>
        <img src="images/creditcards1.gif" width="400" height="59" border="0" usemap="#Map2"> 
        </i></font> 
...
<map name="Map2"> 
  ...
  <area shape="rect" coords="321,8,394,56" href="http://www.discovercard.com" target="_blank">
 </map>
 </body>
