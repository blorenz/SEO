...
env.hosts = ['serpentor.example.com']
env.code_dir = '/srv/www/serpentor'
env.virtualenv = '/srv/www/serpentor/.virtualenv'
env.code_repo = 'git@github.com:user/serpentor.git'
env.django_settings_module = 'serpentor.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/serpentor/wsgi.py" % env.code_dir)
