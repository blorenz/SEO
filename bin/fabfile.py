...
env.hosts = ['uploadcolumbus.example.com']
env.code_dir = '/srv/www/uploadcolumbus'
env.virtualenv = '/srv/www/uploadcolumbus/.virtualenv'
env.code_repo = 'git@github.com:user/uploadcolumbus.git'
env.django_settings_module = 'uploadcolumbus.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/uploadcolumbus/wsgi.py" % env.code_dir)
