...
env.hosts = ['mnms.example.com']
env.code_dir = '/srv/www/mnms'
env.virtualenv = '/srv/www/mnms/.virtualenv'
env.code_repo = 'git@github.com:user/mnms.git'
env.django_settings_module = 'mnms.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/mnms/wsgi.py" % env.code_dir)
