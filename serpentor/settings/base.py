...
INSTALLED_APPS = [
    ...
    # Local apps, referenced via serpentor.appname
]
...
#AUTH_PROFILE_MODULE = 'serpentor.accounts.UserProfile'
...
WSGI_APPLICATION = 'serpentor.wsgi.application'
