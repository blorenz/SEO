...
//   updated for new diamondlot feed    by Randy M. on 8/25/10

class GDTD_Feed_Diamondlot extends GDTD_Feed
{

   protected $feed_name = 'Diamondlot';
   const logfile = '/home/gdtd/feeds/logs/diamondlot_feedlog';
   ...
   public function parseData($data)
    {
      ...
      $this->miles = $data[13];
      $this->transmission = $data[14];
      $this->engine_size = $data[15];
      $this->short_desc = "$data[5] $data[6] $data[7]";
      $this->long_desc = $data[19];
