...
env.hosts = ['adwords_proj.example.com']
env.code_dir = '/srv/www/adwords_proj'
env.virtualenv = '/srv/www/adwords_proj/.virtualenv'
env.code_repo = 'git@github.com:user/adwords_proj.git'
env.django_settings_module = 'adwords_proj.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/adwords_proj/wsgi.py" % env.code_dir)
