...
ROOT_URLCONF = 'adwords_proj.urls'
...
INSTALLED_APPS = [
    ...
    # Local apps, referenced via adwords_proj.appname
]
...
#AUTH_PROFILE_MODULE = 'adwords_proj.accounts.UserProfile'
...
WSGI_APPLICATION = 'adwords_proj.wsgi.application'
